...
<body>
    ...
    <!-- Content Area -->
    <div class="container">
        <div class="alert alert-info" id="dashboardAlert" style="display: none; margin-top: 12px; ">
            <strong>Pesanan Terbaru:</strong>
            Waktu Pesanan Terbaru: {{ isset($waktuPesananTerbaru) ? date('d-m-Y H:i', strtotime($waktuPesananTerbaru)) . ' WIB' : 'Tidak ada data waktu pesanan terbaru' }}
        </div>
        @if (session('success'))
                ...
                <div class='col'>
                    <div class='row'>
                        <div class='cards'>
                            ...
                            <div class="card">
                                <h3>Tambahin Notifikasi pada Inbox, Supaya terus terupdate!</h3>
                                <p>
                                    Waktu Pesanan Masuk Terbaru:
                                    {{ isset($waktuPesananTerbaru) ? date('d-m-Y H:i', strtotime($waktuPesananTerbaru)) . ' WIB' : 'Tidak ada data waktu pesanan terbaru' }}
                                </p>
