...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="{{ route('umkm.messages.inbox') }}"><img src="{{ asset('images/message.png') }}"
                        alt="" id="iconkotakmasuk" style="margin-left: 8px; margin-right:10px;">Kotak Masuk</a>
            </li>
            ...
            <li><a href="{{ route('umkm.konfirmasiKurir') }}"><img src="{{ asset('images/motorbike.png') }}"
                        alt="" id="kelolaKurir" style="margin-left: 8px; margin-right:10px;">Kelola Kurir</a>
            </li>

            <li>
                <form id="logout-form" action="{{ route('umkm.logout') }}" method="POST" style="display: none;">
                    @csrf
                </form>
                <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <img src="{{ asset('images/log-out.png') }}" alt="logout" id="logout"
                        style="margin-left: 8px; margin-right:10px;">Keluar
                </a>
            </li>
        </ul>
    </div>
